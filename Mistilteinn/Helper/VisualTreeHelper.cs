    ...
    public static class VisualTreeHelper
    {
        ...
        public static T FindVisualElement<T>(DependencyObject container) where T : DependencyObject
        {
            ...
            while (childQueue.Count > 0)
            {
                ...
                {
                    childQueue.Enqueue(System.Windows.Media.VisualTreeHelper.GetChild(current, childIndex));
                }
            }
        ...
        public static FrameworkElement FindVisualElementFormName(FrameworkElement container, String name)
        {
            ...
            while (childQueue.Count > 0)
            {
                ...
                for (int childIndex = 0; childIndex < childCount; childIndex++)
                {
                    childQueue.Enqueue(System.Windows.Media.VisualTreeHelper.GetChild(current, childIndex) as FrameworkElement);
                }
            }
